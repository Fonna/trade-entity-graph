...
- ??????????? `relationship_claim` ???????? reconciliation ??
- ??????????????????????
- ?????????????????????????????????????
- ???????????? curated relationship ??? `deprecated`?
...
?? `relationship_claim.relation_status` ????????????????????????????
...
- ?? UI ??????????????????????????????
- ??? `relationship_reconciliation` ?????????????????? MVP ?????
...
`curated_relationship.relation_status` ???????
...
`deprecated` ??????????????????????????????????????????????????????????? `valid_to IS NULL` ???????

### ????

?????????????????

- ? `curated_relationship` ??? `relation_status = 'deprecated'`?
- ????? `valid_to = CURRENT_TIMESTAMP`?
- ???? `curated_relationship`????????????????????
- ???? `supersedes_relationship_id` ????? ID?
- `relationship_decision` ?? `action_type = 'supersede'`?
- `audit_log` ????????????????
...
- `trading_partner_candidate` ?? `trading_partner`?`same_group`?`subsidiary`?`factory_node` ? `sales_center`?
...
????? `confidence_level IN ('medium', 'high')` ????????????????? TEU ?????????????????????????????????
...
- `keep_history`????????claim ????? `history_matched`?????? curated relationship?????????
- `supersede_history`??????????????? `deprecated`?????????? `supersedes_relationship_id` ??????
- `mark_pending_verify`????????? claim ??? `pending_verify`?
...
??????????????????? `apply_history_reuse_to_claims`???????????????????????? claim ???????????
...
?????????? session state ? `claim_id` ????????????????? `claim_id` ???????????????

?????? `history_conflict` ????????????`history_matched` ????????????????????????????????????????
...
- ?????????????????
- ????????????????
- `keep_history` ???????????? curated relationship?
- `supersede_history` ???????? `deprecated`??? `valid_to`????? `verified` ?????? `supersedes_relationship_id`?
- `mark_pending_verify` ??????????
- ?????????? claim ??????????
- ???????????? relationship claim ?????
